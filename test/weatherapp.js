...
Application.prototype = {
  _init: function() {
    ...
    //this.application.connect('activate', Lang.bind(this, this._initMenus));
  ...
  _initButton: function () {
    let clickedAction = new Gio.SimpleAction({ name: 'clicked' });
    clickedAction.connect("button-clicked", Lang.bind(this,function() {
      print("KLIKS!");
    }));
